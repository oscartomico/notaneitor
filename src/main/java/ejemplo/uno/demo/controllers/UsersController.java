...
import ejemplo.uno.demo.services.RolesService;
import ejemplo.uno.demo.services.SecurityService;
import ejemplo.uno.demo.services.UsersService;
import ejemplo.uno.demo.validators.SignUpFormValidator;
...
public class UsersController {
	...
	public String home(Model model) {
	    ...
	    User activeUser = usersService.findUserByDni(dni);
